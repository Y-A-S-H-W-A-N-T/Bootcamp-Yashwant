...
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function loadSongs() {
    ...
    try {
      ...
      songList.innerHTML =
        '<p style="color: red;">Error loading songs. Please try again later.</p>';
    }
  }
      ...
      .map((song) => {
        ...
        return `
            <div class="song-card">
                ...
                <span style="color: ${
                  popularityCategory.color
                }; font-weight: bold;">
                    ${popularityCategory.label}
                </span>
                </p>
                <p class="genre"><strong>Genre:</strong> ${
                  song.playlist_genre || "Unknown Genre"
                }</p>

                <div class="bottom-buttons">
                    <p><strong><i class="fa-solid fa-regular fa-clock fa-beat" style="color: #1db954;"></i></strong> ${formatDuration(
                      song.duration_ms || 0
                    )}</p>
                    ${
                      song.track_id
